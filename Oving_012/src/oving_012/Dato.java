...
public class Dato implements Comparable<Dato> {  // Comparable, se kapittel 12
    ...
    /**
     * Lar datoen være dagens dato, dvs at objektvariabelen kalender har verdien
     * satt et par linjer over!
     */
    public Dato() {
    }
    ...
    /**
     * Metode som sammenligner to datoer. Returnerer negativ verdi hvis this
     * ligger foran parameteren dato i tid, positiv verdi hvis this ligger etter
     * parameteren dato i tid, og 0 hvis de to datoene er like.
     */
    ...
    /**
     * Returnerer antall _hele_ år i forskjell mellom this og parameteren
     * denAndreDatoen. Verdien er positiv hvis denAndreDatoen ligger lenger fram
     * i tid enn this.
     */
    ...
    /**
     * Denne metoden returnerer en beskrivende tekststreng for dato og
     * klokkeslett.
     */
